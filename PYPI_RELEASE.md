...
```
packages/cli/dist/
├── pdf_autofillr_cli-0.2.0.tar.gz      ← source distribution
└── pdf_autofillr_cli-0.2.0-py3-none-any.whl  ← wheel
```
...
pip install "pdf-autofillr-cli==0.2.0" --force-reinstall
...
git commit -m "release: pdf-autofillr-cli v0.2.0"
git tag cli-v0.2.0
...
| Version | Date | PyPI |
|---------|------|------|
| 0.2.0 | 2026-04-30 | https://pypi.org/project/pdf-autofillr-cli/0.2.0/ |
